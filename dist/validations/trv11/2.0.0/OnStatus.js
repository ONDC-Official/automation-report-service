...
exports.checkOnStatus = checkOnStatus;
const assert_1 = __importDefault(require("assert"));
const commonChecks_1 = require("./commonChecks");
const logger_1 = require("../../../utils/logger");
function checkOnStatus(element) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            assert_1.default.strictEqual(fulfillments.length, context.selected_count, "Fulfillments array length should be proportional to selected count");
        ...
        try {
            assert_1.default.ok(authorization.valid_to > context.timestamp, "Authorization.valid_to timestamp should be greater than context.timestamp");
